            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:gap-20 lg:gap-10 gap-10 items-center">
                ...
                <div className="md:order-1 order-2">
                    <h2 className="xl:text-[38px] md:text-4xl text-3xl font-extrabold mb-2 leading-wider">
                        <span className="text-primary-red">Academic or </span>
                        <span className="text-primary-gray block">Educational Documents</span>
                    </h2>
                    <p className="md:pt-4 pt-2 pb-3 md:pb-6 text-primary-gray text-[16px] leading-7 font-medium ">
                    ...
                    <button className="font-Poppins uppercase text-[16px] font-bold bg-primary-red text-primary-white px-8 py-2">
                        Apply Visa
                    </button>
                </div>
            </div>
