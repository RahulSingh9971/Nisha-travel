...
const docLabels: string[] = [
    "Birth Certificate", "Marriage Certificate", "Death Certificate", "Experience Certificate", "Salary Certificate",
    "Power of Attorney", "Property Certificates", "Affidavit", "Medical","PCC","Offer Letter"
];

const PrivateChecklist: React.FC = () => {
    return (
...
export default PrivateChecklist;