...
const ServicesContactpage: React.FC = () => {
  ...
  const handleInputChange = (field: keyof Fromdata, value: string) => {
  ...
  return (
    <section className="bg-white xl:pt-24 md:pt-16 md:pb-0 p-10 font-manrope">
...
export default ServicesContactpage;
