      ...
      <div className="max-w-7xl mx-auto px-4 md:px-10 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-14">
          <div className="max-w-md">
            <h2 className="text-[#0a1e3f] text-4xl font-extrabold tracking-tight">
              Why <br />
              <span className="text-[#0a1e3f]">Choose Us?</span>
            </h2>
          </div>
          <div className="max-w-2xl">
            <p className="text-gray-600 text-sm md:text-base leading-relaxed">
              Choosing the right partner for your overseas journey is more than a decision — it's a commitment to your future. At Nisa Travel Agency, we bring experience, integrity, and a human touch to everything we do.
            </p>
          </div>
        </div>
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="relative w-full h-full transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
                ...
                {/* BACK SIDE (Dark Blue) */}
                <div className="absolute inset-0 w-full h-full bg-[#0a1e3f] text-white rounded-md p-6 flex flex-col items-center justify-center text-center [transform:rotateY(180deg)] [backface-visibility:hidden] shadow-md">
