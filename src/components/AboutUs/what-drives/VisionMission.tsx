...
export const VisionMission: React.FC = () => (
  <section className="font-manrope max-w-7xl mx-auto lg:px-8 md:px-12 px-4 md:pt-16 md:pb-32 pt-10 pb-20 grid grid-cols-1 md:grid-cols-2 xl:gap-16 lg:gap-8 gap-12 ">
    <div className="relative bg-[#F54228] text-white md:p-7 p-4 flex flex-col gap-14 justify-between ">
    ...
    <div className="relative bg-[#EAF0F6] text-[#133a70] md:p-7 p-4 flex flex-col gap-14 justify-between ">
      <div className="flex flex-col gap-2 mb-2">
        <span className="md:w-6 w-4 md:h-6 h-4 rounded-full bg-[#133a70] mr-2" />
