  ...
  <section className="font-manrope max-w-7xl mx-auto lg:px-8 md:px-12 px-4 md:py-16 py-10">
    <div className=" lg:gap-12 md:gap-[60px] grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
      <div className="lg:max-w-xl">
        <h2 className="max-w-md xl:text-5xl md:text-4xl text-3xl font-extrabold  md:mb-6 tracking-wide leading-tight">
          <span className="text-[#0E313A]">Our Journey</span>{" "}
          <span className="text-[#C40808]">Since 1992</span>
        </h2>
        <p className="md:mt-6 mt-3 text-[#666666] text-[16px] leading-7 font-medium">
    ...
    <div className="pt-12 lg:gap-12 md:gap-[60px] grid grid-cols-1 lg:grid-cols-2 gap-10 items-center ">
      ...
      <div className="lg:max-w-xl lg:order-2 order-1">
        <h2 className="max-w-md xl:text-5xl md:text-4xl text-3xl font-extrabold  md:mb-6 tracking-wide leading-tight">
          <span className="text-[#0E313A]">Our Awards</span>{" "}
          <span className="text-[#C40808]">& Achievements</span>
        </h2>
        <p className="md:mt-6 mt-3 text-[#666666] text-[16px] leading-7 font-medium">
            ...
            {awards.map((award, idx) => (
              <li key={idx} className="pl-8 mb-8 last:mb-0 relative">
                ...
                <span className="absolute left-0 top-1.5 flex flex-col items-center">
                 <div className="flex items-center justify-center border-2 border-[#0E313A] rounded-full shadow p-[3px]">
                   <span className=" w-[9px] h-[9px] bg-[#C40808] rounded-full "></span>
                 </div>
                  {idx < awards.length - 1 && (
                    <span className="block w-[2px] h-[110px] bg-[#002661] mx-auto" />
                  )}
                </span>
                {/* Year and title */}
                <span className="block text-xl font-extrabold text-[#C40808]">
                  {award.year}
                </span>
                <span className="block font-extrabold text-[#0E313A]">
                  {award.title}
                </span>
              </li>
            ))}
